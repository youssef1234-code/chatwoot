...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Vt=V,xt=x,dr=Bt,mr=new xt(1),nr=new Vt(mr.buffer),Jt=dr.HIGH,qt=dr.LOW;function zt(r,a,e,t){return mr[0]=r,a[t]=nr[Jt],a[t+e]=nr[qt],a}var gr=zt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var hn=oa,dn=fa,mn=wr,gn=Nr,Sn=Pr,U=[0,0];function wn(r,a){var e,t;return mn.assign(r,U,1,0),e=U[0],e&=dn,t=gn(a),t&=hn,e|=t,Sn(e,U[1])}var On=wn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
