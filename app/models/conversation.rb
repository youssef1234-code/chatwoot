...
#  index_conversations_on_account_ticket              (account_id,is_ticket)
...
#  index_conversations_on_ticket_category             (ticket_category)
#  index_conversations_on_ticket_created_by           (ticket_created_by)
#  index_conversations_on_ticket_number               (ticket_number) UNIQUE
#  index_conversations_on_ticket_priority             (ticket_priority)
#  index_conversations_on_ticket_updated_by           (ticket_updated_by)
#  index_conversations_on_uuid                        (uuid) UNIQUE
#  index_conversations_on_waiting_since               (waiting_since)
#
# Foreign Keys
#
#  fk_rails_...  (ticket_created_by => users.id)
#  fk_rails_...  (ticket_updated_by => users.id)
#
...
class Conversation < ApplicationRecord
  ...
  has_many :nps_survey_responses, dependent: :destroy_async
