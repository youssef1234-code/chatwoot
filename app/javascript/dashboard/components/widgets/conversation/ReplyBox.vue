...
export default {
  ...
  setup() {
    ...
    const popoutReplyBox = defineModel('popout-reply-box', {
      type: Boolean,
      default: false,
    });
  ...
  methods: {
    ...
    confirmOnSendReply() {
      ...
      if (!this.showMentions) {
        ...
        this.clearMessage();
        this.hideEmojiPicker();
        this.$emit('update:popout-reply-box', false);
      }
    },
...
<template>
  ...
  <div ref="replyEditor" class="reply-box" :class="replyBoxClass">
    ...
    <ReplyBottomPanel
      ...
      @open-starred-messages="openStarredMessagesModal"
    />
    <WhatsappTemplates
      :inbox-id="inbox.id"
