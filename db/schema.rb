...
ActiveRecord::Schema[7.1].define(version: 2025_08_18_061753) do
  ...
  create_table "jira_issue_links", force: :cascade do |t|
    ...
    t.index ["last_status_check_at"], name: "index_jira_issue_links_on_last_status_check_at"
  ...
  create_table "messages", id: :serial, force: :cascade do |t|
    ...
    t.index ["conversation_id", "is_pinned"], name: "index_messages_on_conversation_pinned"
    t.index ["conversation_id", "is_starred"], name: "index_messages_on_conversation_starred"
    t.index ["conversation_id"], name: "index_messages_on_conversation_id"
    t.index ["created_at"], name: "index_messages_on_created_at"
    t.index ["inbox_id"], name: "index_messages_on_inbox_id"
    t.index ["pinned_by"], name: "index_messages_on_pinned_by"
    t.index ["sender_type", "sender_id"], name: "index_messages_on_sender_type_and_sender_id"
    t.index ["source_id"], name: "index_messages_on_source_id"
    t.index ["starred_by"], name: "index_messages_on_starred_by"
  end
